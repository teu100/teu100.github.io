...
<head>
    ...
    <script>
        <meta name="facebook-domain-verification" content="wfrh7ir7ar54yfo8u5lshypz1slwju" />
    </script>
</head>
...
<body>
    <div id="container">
        ...
        <div class="imgContainer">
            <img class="backGroundImage" src="./images/white.jpg" alt="backgroundWallpaper">
            <img  class="myPhoto" src="images/meProf.jpg" >
        </div>  
        ...
        <div class="projectsDone">
            ...
            <div id="cs" class="projtabcontent"> 
                <h3>Car Sales</h3>      
        ...
        <div class="botttomNavBar">
            ...
            <div class="SMLinks">
                ...
                <br>
                <br>
                <a href="MateusCardoso.docx" download><img src="./images/cv.png" alt="cvLogo" width="50" height="50"><a href="MateusCardoso.docx" download>Download CV</a>       
            </div>
